  ...
  <nav class="navbar navbar-default navbar-customize navbar-fixed-top" role="navigation" style="height: 81px;">
    ...
    <div class="container">
      ...
      <a class="navbar-brand" style="font-size: 30px;font-weight: 800; margin-top: 10px; " href="#">FunDeli</a>
       ...
       <div class="collapse navbar-collapse  navbar-right" id="bs-FunDeli-navbar-collapse-1" style="height: 121px;">   
          <ul class="nav navbar-nav " style="margin-top: 5px;height: 65px; background-color: rgb(244, 65, 0);">                                               
            
            <li><a href="#myModal" data-toggle="modal" data-target="#myModal" style="color:white; font-weight:border;">Customer</a></li>
            <li><a href="#myModal" data-toggle="modal" data-target="#myModal3" style="color:white;font-weight:border;">Deliver</a></li>
          </ul>
       </div>
    </div>
  </nav>
